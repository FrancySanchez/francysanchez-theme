...
function francysanchez_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'francysanchez_custom_background_args', array(
...
function francysanchez_scripts() {
	...
	wp_enqueue_script( 'francysanchez-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'francysanchez-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
